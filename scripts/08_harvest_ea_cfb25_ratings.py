...
Usage:
    ...
    python scripts/08_harvest_ea_cfb25_ratings.py --limit 500   # dev/test run
    python scripts/08_harvest_ea_cfb25_ratings.py --no-headless  # visible browser for debugging
"""
